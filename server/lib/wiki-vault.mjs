...
export async function ensureVaultScaffold() {
  ...
  await ensureFile(
    ...
    [
      '# AIMemoryHub Vault',
      '',
      'This vault is the Obsidian-facing publication layer for AIMemoryHub.',
      '',
      ...
      '',
      'Use Obsidian to read and navigate this vault. Use AIMemoryHub admin/CLI to publish updates.',
      '',
    ].join('\n'),
  )
  ...
  await ensureFile(
    ...
    [
      '# Vault Index',
      '',
      'This file is regenerated by AIMemoryHub when session pages are published.',
      '',
      '## Sessions',
      '',
  ...
  await ensureFile(
    ...
    [
      ...
      '',
      'This vault is maintained by AIMemoryHub.',
      '',
      '## Core Model',
      '',
...
function renderSessionMarkdown(session, manualNotes = '-', maxMessages = 40, conceptsOverride = null) {
  ...
  lines.push('> Generated by AIMemoryHub for the Obsidian + Syncthing MVP. The `## My Notes` section is preserved across republishes.')
  lines.push('')
